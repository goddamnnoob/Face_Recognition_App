...
import com.drinkwaater.dumbestapp.GraphicOverlay.Graphic;
...
public class FaceGraphic extends Graphic {
    ...
    public FaceGraphic(GraphicOverlay overlay, FirebaseVisionFace face, int facing, Bitmap overlayBitmap, Context context) {
        super(overlay);
